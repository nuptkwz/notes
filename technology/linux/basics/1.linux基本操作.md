...
#结果为
[root@kwz opt]# cat /opt/hello.txt | grep -ni 'hello'
4:hello
```
...
[root@kwz opt]# ls
hello.txt.gz
[root@kwz opt]# gunzip hello.txt.gz
[root@kwz opt]# ls
hello.txt
```
...
# 修改之后
[root@kwz home]# chown kwz apple.txt
[root@kwz home]# ls -ahl
total 4.0K
...
```shell
[root@kwz home]# groupadd monster
[root@kwz home]# useradd -g monster fox
[root@kwz home]# id fox
...
```shell
#创建
[root@kwz home]# touch orange.txt
[root@kwz home]# ls -ahl
-rw-r--r--   1 root   root      0 Aug 21 07:18 orange.txt
#创建组名
[root@kwz home]# groupadd fruit
#修改组名
[root@kwz home]# chgrp fruit apple.txt
[root@kwz home]# ll
...
```shell
[root@kwz home]# id zwj
uid=1009(zwj) gid=1010(mojiao) groups=1010(mojiao)

[root@kwz home]# cat /etc/group | grep wudang
wudang:x:1007:

[root@kwz home]# usermod -g wudang zwj
...
[root@kwz home]# chown jack abc.txt
[root@kwz home]# ll
total 8
